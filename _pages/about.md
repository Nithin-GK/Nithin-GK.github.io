...
profile:
  align: left
  image: SmallSize.png
  image_circular: false # square image with shadow and rounded corners

selected_papers: true # includes a list of papers marked as "selected={true}"
social: false # moved to navbar
social_below_name: true # display social icons right under name

announcements:
  enabled: false # disabled - news removed from main page
